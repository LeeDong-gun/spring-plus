...
public class TodoController {
    ...
    public ResponseEntity<Page<TodoSearchResponseDto>> searchTodos(
        ...
        TodoSearchRequestDto todoSearch = new TodoSearchRequestDto(title, startDate, endDate, managerNickname);
        
        Pageable pageable = PageRequest.of(page-1, size);

        Page<TodoSearchResponseDto> todoSearchResponse = todoService.searchTodos(todoSearch, pageable);

        return ResponseEntity.ok(todoSearchResponse);
    }
